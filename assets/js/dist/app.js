...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		{name: elm$core$Maybe$Nothing, registered: false},
			...
			case 'UpdateName':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							name: elm$core$String$isEmpty(value) ? elm$core$Maybe$Nothing : elm$core$Maybe$Just(value)
						}),
					elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
...
var author$project$Main$isJust = function (maybeValue) {
	if (maybeValue.$ === 'Just') {
		var v = maybeValue.a;
		return true;
	} else {
...
var author$project$Main$isNothing = function (maybeValue) {
	return !author$project$Main$isJust(maybeValue);
};
					...
					[
						...
						_List_fromArray(
							[
								...
								author$project$Main$isNothing(model.name))
							]),
						_List_fromArray(
							[
