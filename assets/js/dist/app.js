...
var author$project$Anonymous$init = _Utils_Tuple2(
	{displayName: elm$core$Maybe$Nothing, username: elm$core$Maybe$Nothing},
	elm$core$Platform$Cmd$none);
var author$project$Main$Anonymous = function (a) {
	return {$: 'Anonymous', a: a};
};
var author$project$Main$GotAnonymousMsg = function (a) {
	return {$: 'GotAnonymousMsg', a: a};
};
...
var author$project$Anonymous$registerUser = function (registration_form) {
			...
			case 'UpdateUsername':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							username: elm$core$String$isEmpty(value) ? elm$core$Maybe$Nothing : elm$core$Maybe$Just(value)
						}),
					elm$core$Platform$Cmd$none);
	...
	function (msg, model) {
		...
		if (_n0.b.$ === 'GotAnonymousMsg') {
			...
			return A3(
				...
				author$project$Main$GotAnonymousMsg,
				A2(author$project$Anonymous$update, subMsg, subModel));
		} else {
			return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
		}
	});
...
var author$project$Anonymous$view = function (model) {
	var submit_disabled = A2(
		elm$core$List$any,
		elm$core$Basics$not,
		A2(
			elm$core$List$map,
							...
							[
								...
								_List_fromArray(
									[
										...
										elm$html$Html$Events$onInput(author$project$Anonymous$UpdateUsername),
							...
							[
								...
								_List_fromArray(
									[
										...
										elm$html$Html$Events$onInput(author$project$Anonymous$UpdateDisplayName),
										elm$html$Html$Attributes$value(
										A2(elm$core$Maybe$withDefault, '', model.displayName))
									]),
								_List_Nil)
							]))
					])),
		...
		body: function () {
			var subView = function () {
				...
				return A2(
					elm$html$Html$map,
					author$project$Main$GotAnonymousMsg,
					author$project$Anonymous$view(subModel));
			}();
			return _List_fromArray(
				[
					A2(
